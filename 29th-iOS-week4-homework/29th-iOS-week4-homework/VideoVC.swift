...
class VideoVC: UIViewController {
    ...
    @IBAction func touchUpToLogin(_ sender: UIButton) {
        ...
        let secondStoryboard = UIStoryboard.init(name: "GoogleLogin", bundle: nil)
        guard let secondVC = secondStoryboard.instantiateViewController(identifier: "NavigationViewController") as? NavigationViewController else {return}
